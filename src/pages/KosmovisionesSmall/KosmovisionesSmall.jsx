...
import kosmovisionesIcon from "../../assets/images/kosmovisiones-nft.svg";
          ...
          <div className="ArtistSmall__maincontent_wrapper">
            ...
            <div className="ArtistSmall__box_container">
              <div className="ArtistSmall__box_header">
                <NameSlide firtsName="BY RODRIGO" lastName="SALCEDO ///" />
              </div>
...
export default KosmovisionesSmall;
